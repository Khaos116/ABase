...
/**
 * 1.https://blog.csdn.net/Henzel/article/details/94739860
 * 2.https://github.com/qdsfdhvh/DanDanPlayForTVPersonal/blob/c4f0d4ae51/common/src/main/java/com/seiko/common/util/fix/IMMLeaks.java
...
public class IMMLeaks {
  ...
  public static void fixFocusedViewLeak(Application application) {
    ...
    application.registerActivityLifecycleCallbacks(new LifecycleCallbacksAdapter() {
      @Override public void onActivityCreated(@NotNull Activity activity, Bundle savedInstanceState) {
  ...
  public static class LifecycleCallbacksAdapter implements Application.ActivityLifecycleCallbacks {
    ...
    @Override public void onActivityStarted(@NotNull Activity activity) {
    }

    @Override public void onActivityResumed(@NotNull Activity activity) {
    }

    @Override public void onActivityPaused(@NotNull Activity activity) {
    }

    @Override public void onActivityStopped(@NotNull Activity activity) {
    }

    @Override public void onActivitySaveInstanceState(@NotNull Activity activity, @NotNull Bundle outState) {
    }

    @Override public void onActivityDestroyed(@NotNull Activity activity) {
    }
  }
}