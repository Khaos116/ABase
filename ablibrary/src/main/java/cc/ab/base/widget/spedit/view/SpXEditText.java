...
import cc.ab.base.widget.spedit.mention.watcher.SpanChangedWatcher;
...
public class SpXEditText extends AppCompatEditText {
  ...
  private KeyEventProxy mKeyEventProxy = new SelectDeleteKeyEventProxy();
...

  {
    ...
    setOnKeyListener(new OnKeyListener() {
      @Override public boolean onKey(View v, int keyCode, KeyEvent event) {
        return SpXEditText.this.handleKeyEvent(event);
      }
    });
  }
