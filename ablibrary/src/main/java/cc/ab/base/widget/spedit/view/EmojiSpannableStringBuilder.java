...
public class EmojiSpannableStringBuilder extends SpannableStringBuilder {
    ...
    EmojiSpannableStringBuilder(@NonNull Class<?> watcherClass) {
        mWatcherClass = watcherClass;
    }


    EmojiSpannableStringBuilder(@NonNull Class<?> watcherClass, @NonNull CharSequence text) {
        super(text);
        mWatcherClass = watcherClass;
    }


    EmojiSpannableStringBuilder(@NonNull Class<?> watcherClass, @NonNull CharSequence text, int start,
            int end) {
        super(text, start, end);
        mWatcherClass = watcherClass;
    }

    static EmojiSpannableStringBuilder create(@NonNull
        Class<?> clazz, @NonNull CharSequence text) {
    ...
    public CharSequence subSequence(int start, int end) {
        return new EmojiSpannableStringBuilder(mWatcherClass, this, start, end);
    }
