...
/**
 * https://github.com/airbnb/epoxy/blob/master/epoxy-adapter/src/main/java/com/airbnb/epoxy/stickyheader/StickyHeaderLinearLayoutManager.kt
 *
...
@JvmOverloads constructor(
...
) : LinearLayoutManager(context, orientation, reverseLayout) where T : RecyclerView.Adapter<*>, T : StickyHeaderCallbacks {
  ...
  private fun setAdapter(newAdapter: RecyclerView.Adapter<*>?) {
    ...
    if (newAdapter is StickyHeaderCallbacks) {
