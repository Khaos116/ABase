 ...
 */
class VerticalPagerItemView @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
    defStyleRes: Int = 0) : FrameLayout(context, attrs, defStyleAttr, defStyleRes), IControlComponent {
  ...
  init {
    LayoutInflater.from(getContext()).inflate(R.layout.item_vertical_page, this, true)
    thumb = itemVerticalThumb
    mPlayBtn = itemVerticalBtn
    mLoadingView = itemVerticalLoading
