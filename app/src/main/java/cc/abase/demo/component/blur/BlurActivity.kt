...
class BlurActivity : CommBindTitleActivity<ActivityBlurBinding>() {
  ...
  override fun initContentView() {
    ...
    viewBinding.blurIv1.loadCoilUrl(url = url, holderRatio = 1125f / 642, blurRadius = 5f)
    viewBinding.blurIv2.loadCoilUrl(url = url, holderRatio = 1125f / 642, blurRadius = 10f, blackWhite = true)
    viewBinding.blurIv3.loadCoilUrl(url = url, holderRatio = 1125f / 642, blurRadius = 15f)
  }
  //</editor-fold>
}