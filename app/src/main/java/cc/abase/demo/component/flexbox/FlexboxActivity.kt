...
import kotlinx.android.synthetic.main.activity_flexbox.flexboxLayout
...
class FlexboxActivity : CommTitleActivity() {
  ...
  override fun layoutResContentId() = R.layout.activity_flexbox
  ...
  override fun initData() {
    //主轴项目排列方向
    flexboxLayout.flexDirection = FlexDirection.ROW//主轴为水平方向，起点在左端
    //换行方式
    flexboxLayout.flexWrap = FlexWrap.WRAP//按正常方向换行
    //主轴上的对齐方式
    flexboxLayout.justifyContent = JustifyContent.FLEX_START//默认值，左对齐
    //添加view
    addView(flexboxLayout, tags)
  }
