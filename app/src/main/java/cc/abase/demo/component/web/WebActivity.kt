    ...
    private val webChromeClient = object : com.just.agentweb.WebChromeClient() {
        ...
        override fun onShowFileChooser(
            ...
            fileChooserParams?.acceptTypes?.firstOrNull()?.let { type ->
                ...
                when {
                    type.startsWith("image/") -> checkSD(PictureMimeType.ofImage())
                    type.startsWith("video/") -> checkSD(PictureMimeType.ofVideo())
                    type.startsWith("audio/") -> checkSD(PictureMimeType.ofAudio())
                    else -> {
