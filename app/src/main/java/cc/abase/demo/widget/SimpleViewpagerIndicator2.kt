...
class SimpleViewpagerIndicator2 @JvmOverloads constructor(
  ...
  private fun init() {
    ...
    parentPadding = dp2px(parentPadding.toFloat())
  ...
  fun setTabRound(tabRound: Int): SimpleViewpagerIndicator2 {
    this.tabRound = tabRound
    return this
  }
    ...
    override fun onPageScrolled(position: Int, positionOffset: Float, positionOffsetPixels: Int) {
      ...
      for (i in 0 until count) {
        ...
        if (i != sel) {
          ...
          tv.setTextSize(TypedValue.COMPLEX_UNIT_PX, tabTextSize.toFloat())
